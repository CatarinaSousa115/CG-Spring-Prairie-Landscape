...
export class DirtPatchLayer {
  constructor(scene, terrain, options = {}) {
    ...
    this.texture_dry = new CGFtexture(scene,"textures/dirt_patch.png");
    this.texture_meadow = new CGFtexture(scene,"textures/meadow.png");
    ...
    this.dryAppearance.setTextureWrap("REPEAT", "REPEAT");
    ...
    this.meadowAppearance.setTextureWrap("REPEAT", "REPEAT");
  }
