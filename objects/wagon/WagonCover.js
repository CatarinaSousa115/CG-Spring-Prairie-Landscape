...
export class WagonCover {
    ...
    displaySkirt() {
        ...
        this.ribBlock.displayBetween(-x, -x + t, this.wallHeight - this.skirtHeight, this.wallHeight, -0.5, 0.5);
        this.ribBlock.displayBetween(x - t, x, this.wallHeight - this.skirtHeight, this.wallHeight, -0.5, 0.5);
    }
    ...
    displayRibLegs(z) {
        ...
        this.ribBlock.displayBetween(-x - t / 2, -x + t / 2, -0.02, this.wallHeight, z - t / 2, z + t / 2);
        this.ribBlock.displayBetween(x - t / 2, x + t / 2, -0.02, this.wallHeight, z - t / 2, z + t / 2);
    }
